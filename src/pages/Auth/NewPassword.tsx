...
const PasswordResetPage: React.FC = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gray-50 dark:bg-gray-800">
            {isPasswordReset ? (
                <p className="text-gray-700 dark:text-gray-300 text-center mb-16">Your password has been reset successfully. Redirecting...</p>
            ) : (
                <>
                    <div className="max-w-4xl bg-white dark:bg-gray-700 rounded-md shadow-lg p-8 w-full">
                        <h1 className="text-3xl font-bold text-center text-gray-800 dark:text-white mb-6">Reset Password</h1>
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">Password Confirmation</label>
                                <input
                                    type="password"
